...
| 9 | [Notifications & Patient PWA](docs/GITHUB/MILESTONES/M9_notifications_patient_pwa.md) | 63–71 | 9–10 | `v0.9.0` | 🟩🟩⬜⬜⬜⬜⬜⬜⬜⬜ **22%** (2/9 issues) |
...
| ⭐ | **First official release:** every issue 1–109 closed | - | end of 14 | **`v1.0.0`** | 🟩🟩🟩🟩🟩🟩⬜⬜⬜⬜ **59%** (64/109 issues) |
...
**Phase:** building. **Sprints 1–5 of 14 complete**, sprints 6 to 11 under way (semester 2). **64 of 109
...
data's age always shown (issue 68).
