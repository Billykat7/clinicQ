...
| 9 | [Notifications & Patient PWA](docs/GITHUB/MILESTONES/M9_notifications_patient_pwa.md) | 63–71 | 9–10 | `v0.9.0` | 🟩🟩🟩🟩🟩🟩🟩🟩⬜⬜ **78%** (7/9 issues) |
...
| ⭐ | **First official release:** every issue 1–109 closed | - | end of 14 | **`v1.0.0`** | 🟩🟩🟩🟩🟩🟩⬜⬜⬜⬜ **63%** (69/109 issues) |
...
**Phase:** building. **Sprints 1–5 of 14 complete**, sprints 6 to 11 under way (semester 2). **69 of 109
...
that shows the last place in line it saw, and how long ago, when there is no signal, and picks up a new release on its next launch (issue 69).
