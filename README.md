...
| **[Milestones & issues](docs/GITHUB/README.md)** | 15 milestones, 121 tracked issues, conventions, release tags, pipeline strategy |
...
| 8 | [Display Monitor](docs/GITHUB/MILESTONES/M8_display_monitor.md) | 56–62, 237 | 9 | `v0.8.0` | 🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩 **100%** (8/8 issues) |
...
| ⭐ | **First official release:** every tracked issue closed | - | end of 14 | **`v1.0.0`** | 🟩🟩🟩🟩🟩🟩🟩🟩⬜⬜ **75%** (91/121 issues) |
