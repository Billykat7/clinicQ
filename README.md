...
| 5 | [Discovery & Geolocation](docs/GITHUB/MILESTONES/M5_discovery_geolocation.md) | 31–38 | 5–6 | `v0.5.0` | 🟩🟩🟩🟩🟩🟩🟩🟩🟩⬜ **88%** (7/8 issues) |
...
| ⭐ | **First official release:** every issue 1–109 closed | - | end of 14 | **`v1.0.0`** | 🟩🟩🟩⬜⬜⬜⬜⬜⬜⬜ **34%** (37/109 issues) |
...
**Phase:** building. **Sprints 1–4 of 14 complete**, sprint 5 under way (semester 2). **37 of 109
