...
| 5 | [Discovery & Geolocation](docs/GITHUB/MILESTONES/M5_discovery_geolocation.md) | 31–38 | 5–6 | `v0.5.0` | 🟩🟩🟩🟩🟩🟩🟩🟩⬜⬜ **75%** (6/8 issues) |
...
| ⭐ | **First official release:** every issue 1–109 closed | - | end of 14 | **`v1.0.0`** | 🟩🟩🟩⬜⬜⬜⬜⬜⬜⬜ **33%** (36/109 issues) |
...
**Phase:** building. **Sprints 1–4 of 14 complete**, sprint 5 under way (semester 2). **36 of 109
