...
| 8 | [Display Monitor](docs/GITHUB/MILESTONES/M8_display_monitor.md) | 56–62 | 9 | `v0.8.0` | 🟩🟩🟩🟩🟩🟩🟩🟩🟩⬜ **86%** (6/7 issues) |
...
| ⭐ | **First official release:** every issue 1–109 closed | - | end of 14 | **`v1.0.0`** | 🟩🟩🟩🟩🟩🟩⬜⬜⬜⬜ **56%** (61/109 issues) |
...
**Phase:** building. **Sprints 1–5 of 14 complete**, sprints 6 to 11 under way (semester 2). **61 of 109
...
browser tests in CI (issue 55). M8, the waiting-room display, is under way: the server-side privacy
...
number and the room in the clinic's language, one at a time, never a name) (issue 60), are in.
