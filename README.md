...
| 7 | [Clinic Dashboard](docs/GITHUB/MILESTONES/M7_clinic_dashboard.md) | 48–55 | 8–9 | `v0.7.0` | 🟩🟩🟩🟩⬜⬜⬜⬜⬜⬜ **38%** (3/8 issues) |
...
| ⭐ | **First official release:** every issue 1–109 closed | - | end of 14 | **`v1.0.0`** | 🟩🟩🟩🟩🟩⬜⬜⬜⬜⬜ **46%** (50/109 issues) |
...
**Phase:** building. **Sprints 1–5 of 14 complete**, sprints 6 and 7 under way (semester 2). **50 of 109
...
moving a patient forward with a reason, a staff-only badge and the trail the manager reads (issue 52), and
