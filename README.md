...
| 9 | [Notifications & Patient PWA](docs/GITHUB/MILESTONES/M9_notifications_patient_pwa.md) | 63–71 | 9–10 | `v0.9.0` | 🟩🟩🟩🟩⬜⬜⬜⬜⬜⬜ **44%** (4/9 issues) |
...
| ⭐ | **First official release:** every issue 1–109 closed | - | end of 14 | **`v1.0.0`** | 🟩🟩🟩🟩🟩🟩⬜⬜⬜⬜ **61%** (66/109 issues) |
...
**Phase:** building. **Sprints 1–5 of 14 complete**, sprints 6 to 11 under way (semester 2). **66 of 109
...
stop the spend and alert the team, with every message fitted to one segment and its cost recorded (issue 65).
