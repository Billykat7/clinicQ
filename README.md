...
| 8 | [Display Monitor](docs/GITHUB/MILESTONES/M8_display_monitor.md) | 56–62 | 9 | `v0.8.0` | 🟩⬜⬜⬜⬜⬜⬜⬜⬜⬜ **14%** (1/7 issues) |
...
| ⭐ | **First official release:** every issue 1–109 closed | - | end of 14 | **`v1.0.0`** | 🟩🟩🟩🟩🟩⬜⬜⬜⬜⬜ **51%** (56/109 issues) |
...
**Phase:** building. **Sprints 1–5 of 14 complete**, sprints 6 to 9 and 11 under way (semester 2). **56 of 109
...
consent read afresh on every update (issue 58), is in.
