...
| 8 | [Display Monitor](docs/GITHUB/MILESTONES/M8_display_monitor.md) | 56–62 | 9 | `v0.8.0` | 🟩🟩🟩⬜⬜⬜⬜⬜⬜⬜ **29%** (2/7 issues) |
...
| ⭐ | **First official release:** every issue 1–109 closed | - | end of 14 | **`v1.0.0`** | 🟩🟩🟩🟩🟩⬜⬜⬜⬜⬜ **52%** (57/109 issues) |
...
**Phase:** building. **Sprints 1–5 of 14 complete**, sprints 6 to 9 and 11 under way (semester 2). **57 of 109
...
32-inch screen in every layout from one queue to a page of four (issue 56), are in.
