...
| 6 | [**Queue Engine Core**](docs/GITHUB/MILESTONES/M6_queue_engine_core.md) ⚠️ critical path | 39–47 | 6–7 | `v0.6.0` | 🟩⬜⬜⬜⬜⬜⬜⬜⬜⬜ **11%** (1/9 issues) |
...
| ⭐ | **First official release:** every issue 1–109 closed | - | end of 14 | **`v1.0.0`** | 🟩🟩🟩🟩⬜⬜⬜⬜⬜⬜ **36%** (39/109 issues) |
...
**Phase:** building. **Sprints 1–5 of 14 complete**, sprint 6 under way (semester 2). **39 of 109
issues closed**. `v0.2.0` is the only tag cut so far; the notes for `v0.1.0` and `v0.3.0`–`v0.5.0` are
written and their tags are still to cut, in order. M6, the queue engine, is under way: tickets and their numbering (issue 39) are in.
