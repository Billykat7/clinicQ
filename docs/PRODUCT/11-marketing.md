...
| **Multi-branch private practice groups** | One decision-maker, multiple sites - efficient sales motion | "One dashboard across all your branches, compare wait times, one subscription" |
...
- Do not disparage existing hospital/clinic systems by name - position as a lightweight discovery/queue
