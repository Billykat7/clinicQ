...
| **5** | 9–10 | M4 · M5 | 🚧 in progress — M4 closed, tag `v0.4.0` to follow; M5 under way (issues 31, 32, 34, 35, 36 closed) |
...
release note `v0.4.0`), its M5 half is under way — and by the rule below a sprint is ticked only
