...
| **10** | 19–20 | M9 · M10 | 🚧 in progress — board accessibility [59], the kiosk device registry [61] and audio announcements [60] delivered with M8; proxy booking [84], virtual waiting room [86], WhatsApp webhook [75], templates [76], accessibility audit [101], resilience [62], reports UI [89] and KPIs [90] not started |
...
not done:** the queue engine, every dashboard issue (48–55), board privacy (58), the board page (56), the board's live stream (57), board accessibility (59), kiosk devices (61) and board announcements (60) are delivered, while those sprints' other
