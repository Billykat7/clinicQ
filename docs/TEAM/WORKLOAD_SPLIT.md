...
started (M9's 67, 69 and 70 and M11's 80, 81, 82, 83, 84, 86 and 87 are delivered) — and by the rule below a sprint is ticked only when *every* issue its lanes deliver is closed.
