...
| **Be reminded when a medicine collection is due**, and take a place with one word or one tap | An SMS or push reminder; reply `COLLECT`, or tap the notification's button | Yes, where the clinic has set a repeat up for you (Issue 85) |
