...
| **[M15: Clinic Onboarding & Patient Sign-in](MILESTONES/M15_clinic_onboarding_patient_sign_in.md)** | Patient email sign-in behind a flag, email transport, `sites.onboarding` RBAC, clinics console, clinic setup link | 219–223 | Backend Lead + Frontend/Clinic | 🟩🟩🟩🟩🟩🟩🟩🟩🟩🟩 **100%** ✅ done |

**Total: 116 tracked issues across M1–M15**, plus 6 parked
[backlog items](ISSUES/BACKLOG/).

**Progress:** 🟩🟩🟩🟩🟩🟩🟩⬜⬜⬜ **74%** (86/116 issues) closed · **11 of 15 milestones done**
