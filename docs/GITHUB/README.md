...
| **[M8: Waiting-room Display Monitor](MILESTONES/M8_display_monitor.md)** | Kiosk board, SSE, privacy modes, accessibility, audio call-out, device registry | 56–62 | Frontend (Clinic) | 🟩🟩🟩🟩🟩🟩🟩🟩🟩⬜ **86%** 🚧 in progress |
...
**Progress:** 🟩🟩🟩🟩🟩🟩⬜⬜⬜⬜ **56%** (61/109 issues) closed · **7 of 14 milestones done**
