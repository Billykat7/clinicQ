...
| **[M15: Clinic Onboarding & Patient Sign-in](MILESTONES/M15_clinic_onboarding_patient_sign_in.md)** | Patient email sign-in behind a flag, email transport, `sites.onboarding` RBAC, clinics console, clinic setup link | 219–223 | Backend Lead + Frontend/Clinic | 🟩🟩🟩🟩🟩🟩🟩🟩⬜⬜ **78%** 🚧 in progress |

**Total: 116 tracked issues across M1–M15**, plus 6 parked
[backlog items](ISSUES/BACKLOG/).

**Progress:** 🟩🟩🟩🟩🟩🟩🟩⬜⬜⬜ **73%** (88/120 issues) closed · **10 of 15 milestones done**
