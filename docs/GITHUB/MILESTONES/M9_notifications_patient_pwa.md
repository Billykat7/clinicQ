...
| | |
|---|---|
| **Status** | 🚧 In progress: the notification service, transports and delivery log (63), the patient ticket page (68), web push (64), the SMS gateway with cost caps (65), versioned templates with their editor (66; English only until Issue 77) patient preferences with quiet hours and STOP across every channel (67) and the installable app with its offline last-known ticket (69) delivered |
