...
| | |
|---|---|
| **Status** | 🚧 In progress: appointment slots with one daily limit shared with walk-ins (80) the virtual waiting room with travel-time call-forward (86) and post-visit feedback with its report (87) delivered |
