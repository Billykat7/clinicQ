...
| | |
|---|---|
| **Status** | 🚧 In progress: issues 48 (the dashboard shell, role-aware navigation and the site switcher) and 52 (reordering with reason codes and the override trail) delivered |
| **Progress** | 🟩🟩⬜⬜⬜⬜⬜⬜⬜⬜ **25%** (2/8 issues) |
