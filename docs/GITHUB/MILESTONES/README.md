...
| [M9: Notifications & Patient PWA](M9_notifications_patient_pwa.md) | Patients hear when it is their turn (push, SMS or WhatsApp) and can follow their place in line from an installable app. | 9–10 | 63–71, 200 | `v0.9.0` |
