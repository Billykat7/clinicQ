...
class Settings(BaseSettings):
    ...
    patient_join_enabled: bool = Field(
        ...
        description=(
            ...
            "that takes remote joins, and let the join page sign a patient in and join (env: "
            "PATIENT_JOIN_ENABLED). While off, the button is shown disabled with the reason, and the "
            "join page says the same with no form."
        ),
    )
