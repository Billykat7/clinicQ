"""Patient model: a phone number, and nothing that needs a password (Issue 17).
...
whole identity is a mobile number the patient proves with a one-time code (or that a USSD or
WhatsApp gateway vouches for). There is **no password column**, and no column that could hold one;
